package com.springweb.framework.batch;
...
public class SpringBatchRunner {
	 ...
	 * @param jobRepository
	 */
	public SpringBatchRunner(JobOperator jobOperator, JobExplorer jobExplorer, JobRepository jobRepository) {
